      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Seamless Advertising,<br className="hidden sm:block" />Powerful Publishing
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Built with smart technology to simplify, connect, and adapt to the unique needs of advertisers and publishers.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Linkfro intelligently connects advertisers with the right publishers, ensuring relevant and impactful placements."
            index={0}
          />
          <FeatureCard
            ...
            description="Advertisers and publishers communicate easily, streamlining content approvals and posting."
            index={1}
          />
          <FeatureCard
            ...
            description="Built-in protocols ensure smooth, transparent transactions for advertisers and publishers."
            index={2}
          />
          <FeatureCard
            ...
            description="From small campaigns to large-scale promotions, Linkfro adapts to your business needs."
            index={3}
          />
          <FeatureCard
            ...
            description="Built-in safeguards protect payments, data, and content across the platform."
            index={4}
          />
          <FeatureCard
            ...
            description="Manage, track, and optimize content placements all in one place."
            index={5}
          />
        </div>
      </div>
