          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    At Linkfro, we envision a seamless marketplace where advertisers and publishers connect with trust and transparency.
                  </h3>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    We strive to empower businesses with meaningful placements while helping publishers unlock the true value of their platforms.
                  </h3>
                </div>
              </div>
            </div>
