...
interface ConsumerSidebarProps {
  activeTab: "marketplace" | "cart" | "purchases" | "pendingPayments" | "adRequests" | "contentRequests" | "analytics";
  setActiveTab: (tab: "marketplace" | "cart" | "purchases" | "pendingPayments" | "adRequests" | "contentRequests" | "analytics") => void;
  stats: {
    total: number;
    purchases: number;
          ...
          <div className="p-3 border-t">
            <div className="flex items-center">
              ...
              <motion.li variants={variants}>
                {!isCollapsed && (
                  <div className="ml-2">
                    <p className="text-xs font-semibold text-gray-900">Consumer</p>
